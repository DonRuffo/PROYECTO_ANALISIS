...
tablaCOVID.to_csv('Covid_19.csv')
tablaCOMIDA.to_csv('Comida_rapida.csv')
tablaPIZZA.to_csv('Domino´s Pizza.csv')
tablaJUEGOS.to_csv('Juegos_olímpicos.csv')
tablaORQUESTA.to_csv('Orquesta_NY.csv')
tablaPHISH.to_csv('Banda_Phish.csv')
tablaSPOTIFY.to_csv('Canciones_Spotify.csv')